...
class Display:
    ...
    def control_fan(self):
        ...
        Default mode: Scale fan speed linearly (0-50%) between 65 and 85 degrees Celsius
        Turbo mode: Scale fan speed linearly (0-100%) between 50 and 85 degrees Celsius
        """
        while True:
            temperatures = [self.system_parameters.cpu_temperature,
    ...
    def HMI1(self):
        ...
        # Network speed
        TX = self.system_parameters.tx_speed
        ...
        RX = self.system_parameters.rx_speed
        ...
        if disk_parameters.disk0.capacity == 0:
            ...
            draw.text((80, 176), str(math.floor(disk_parameters.disk0.used_percentage)) + '%', fill=0xf1b400,
                      font=font02_13, )
        # Disk 1 Usage
        if disk_parameters.disk1.capacity == 0:
            ...
            draw.text((80, 196), str(math.floor(disk_parameters.disk1.used_percentage)) + '%', fill=0xf1b400,
                      font=font02_13, )
        # RAID Check
